<?php
$sps = Sanpham::model ()->findAll ( array (	"condition" => "type = '6'") );
if($sps != null){	
	?>
	...
	foreach($sps as $thisSp){
		...
		<tr style="height: 100px;">	
			...
			<td style="border: 1px solid #888 ;min-width: 120; text-align: center;" ><a href="<?php echo Yii::app()->request->baseUrl."/admin123465789/sqcf?id=".$thisSp->id;?>">Sửa</a></td>
